...
export class RoomTypeController {
    ...
    removeRoomType(@Req() req: Request, @Param('id', ParseIntPipe) id: number) {
        return this.roomTypeService.removeRoomType(this.getHotelId(req), id);
    }

    @Patch('room-types/:id/restore')
    restoreRoomType(@Req() req: Request, @Param('id', ParseIntPipe) id: number) {
